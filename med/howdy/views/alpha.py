...
from howdy.test import main1
from howdy.file import main
import os
...
def check_currency(request):
     ...
     print("5")
     with open(os.path.join("test_images\\1.jpg"), 'wb+') as destination:
        for chunk in request.FILES['image'].chunks():
            destination.write(chunk)
     file_n ,f_type= main1()
     return HttpResponse(display_page.format(file_n,f_type))
...
<body>
    <center><h2>Bring your tablet in front of camera</h2>
    <br>
    <form  action="http://192.168.43.147:8000/" id="mForm"  method="post"  enctype="multipart/form-data">
...
<body>
    ...
    <form  action="http://192.168.43.147:8000/"  method="post"  enctype="multipart/form-data">
    ...
    <source src="http://www.sitsark.in/proj/{}" type="audio/{}">
    </audio>
</body>
</html>"""